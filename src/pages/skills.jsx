      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 pt-2 px-2 lg:px-4">
          ...
          <div className="sm:col-span-1 md:col-span-2">
            <h2 className="mb-3 text-cobalt text-center">Tech Stack Skills</h2>
          ...
          <div>
            {/* Column 3 top "TRAINING" that will stack on desktop, side by side on tablets, and hidden on small screens.  */}
            <div className="hidden lg:grid lg:grid-cols-1 lg:grid-rows-2">
              <div className="mb-10">
              ...
              <div className="text-gray-700 mt-4 border-l-4 border-fuchsia-700 pl-2">
                Levels reflect whether I've learned a skill in theory, used it
                in practice, or worked extensively with it.
              </div>
            </div>
          </div>
        </div>
        <div className="mx-8 col-span-2 text-gray-700 mt-4 border-l-4 border-fuchsia-700 pl-2 lg:hidden">
          Click a skill for details. Levels reflect whether I've learned a skill
          in theory, used it in practice, or worked extensively with it.
        </div>
      </div>
    </main>
  );
